## BitcoinSubsidiumcoin Metadata Specification

Additional fields may be added, but will be ignored by BitcoinSubsidiumcoin.
...
```
{
   ...
   "contract_signature": "<BitcoinSubsidiumcoin signed contract_hash>",
