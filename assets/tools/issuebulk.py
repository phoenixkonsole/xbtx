#!/usr/bin/env python3
# Script to issue assets on the BitcoinSubsidiumcoin platform
...
# Prerequisite: BitcoinSubsidiumd daemon to be running
...
#Set this to your BitcoinSubsidium-cli program
cli = "BitcoinSubsidium-cli"

mode =  "-testnet"
rpc_port = 18766
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "BitcoinSubsidium Assets - Sheet1.csv"
#Set this information in your BitcoinSubsidium.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
