...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinSubsidiumTestFramework
    pass

class ExampleTest(BitcoinSubsidiumTestFramework):
    # Each functional test is a subclass of the BitcoinSubsidiumTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinSubsidiumTestFramework class so other tests can use it."""
