...
class TxnMallTest(BitcoinSubsidiumTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 XBTS:
        ...
        # First: use raw transaction API to send 1240 XBTS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 XBTS coin each
        ...
        # Node0's balance should be starting balance, plus 50XBTS for another
        ...
        # Node0's total balance should be starting balance, plus 100XBTS for 
