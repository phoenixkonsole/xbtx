...
# TestNode: A peer we use to send messages to BitcoinSubsidiumd, and store responses.
...
class CompactBlocksTest(BitcoinSubsidiumTestFramework):
    ...
    # This test actually causes BitcoinSubsidiumd to (reasonably!) disconnect us, so do this last.
    ...
    # BitcoinSubsidiumd's choice of nonce.
    ...
    # Test that BitcoinSubsidiumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for BitcoinSubsidiumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # BitcoinSubsidiumd will not send blocktxn responses for blocks whose height is
