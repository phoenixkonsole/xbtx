...
class AssetTest(BitcoinSubsidiumTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("BitcoinSubsidium1", 1000)
        n0.issue("BitcoinSubsidium2", 1000)
        n0.issue("BitcoinSubsidium3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="BitcoinSubsidium*", verbose=False, count=2, start=-2)
        ...
        BitcoinSubsidium_assets = n0.listassets(asset="BitcoinSubsidium*", verbose=False, count=2, start=-2)
        assert_equal(len(BitcoinSubsidium_assets), 2)
        assert_equal(BitcoinSubsidium_assets[0], "BitcoinSubsidium2")
        assert_equal(BitcoinSubsidium_assets[1], "BitcoinSubsidium3")
        self.sync_all()
