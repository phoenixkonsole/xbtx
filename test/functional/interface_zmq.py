...
from test_framework.test_framework import BitcoinSubsidiumTestFramework, SkipTest
...
class ZMQTest (BitcoinSubsidiumTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that BitcoinSubsidium has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("BitcoinSubsidiumd has not been built with zmq enabled.")
