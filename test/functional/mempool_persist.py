...
By default, BitcoinSubsidiumd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinSubsidiumTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give BitcoinSubsidiumd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent BitcoinSubsidiumd from writing mempool.dat to disk. Verify that `savemempool` fails")
