...
DISTNAME=BitcoinSubsidium-2.0.3
MAKEOPTS="-j4"
BRANCH=master
clear
if [[ $EUID -ne 0 ]]; then
...
rm -rf ~/BitcoinSubsidiumcoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../BitcoinSubsidiumcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../BitcoinSubsidiumcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/BitcoinSubsidiumcoin/temp
cd ~/BitcoinSubsidiumcoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/BitcoinSubsidiumcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/BitcoinSubsidiumcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
