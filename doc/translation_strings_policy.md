...
This document provides guidelines for internationalization of the BitcoinSubsidium Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to BitcoinSubsidium network</source>
        <translation>
            <numerusform>%n active connection to BitcoinSubsidium network</numerusform>
            <numerusform>%n active connections to BitcoinSubsidium network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `BitcoinSubsidium_en.ts` remains unchanged.
