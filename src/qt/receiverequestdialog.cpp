...
#include "config/BitcoinSubsidium-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcoinSubsidiumURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BitcoinSubsidiumUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitcoinSubsidiumURI(info));
}
