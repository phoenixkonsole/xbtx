...
#ifndef BitcoinSubsidium_QT_SENDCOINSDIALOG_H
#define BitcoinSubsidium_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending BitcoinSubsidiums */
...
#endif // BitcoinSubsidium_QT_SENDCOINSDIALOG_H
