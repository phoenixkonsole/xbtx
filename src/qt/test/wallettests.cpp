...
#include "qt/BitcoinSubsidiumamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BitcoinSubsidiumAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_BitcoinSubsidium-qt -platform xcb      # Linux
//     src/qt/test/test_BitcoinSubsidium-qt -platform windows  # Windows
//     src/qt/test/test_BitcoinSubsidium-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = BitcoinSubsidiumUnits::formatWithUnit(unit, balance, false, BitcoinSubsidiumUnits::separatorAlways);
    ...
    // Amount input
    BitcoinSubsidiumAmountField* amountInput = receiveCoinsDialog.findChild<BitcoinSubsidiumAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: BitcoinSubsidium:")) != -1);
