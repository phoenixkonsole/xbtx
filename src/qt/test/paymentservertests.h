...
#ifndef BitcoinSubsidium_QT_TEST_PAYMENTSERVERTESTS_H
#define BitcoinSubsidium_QT_TEST_PAYMENTSERVERTESTS_H
...
#endif // BitcoinSubsidium_QT_TEST_PAYMENTSERVERTESTS_H
