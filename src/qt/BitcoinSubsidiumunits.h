...
#ifndef BitcoinSubsidium_QT_BitcoinSubsidiumUNITS_H
#define BitcoinSubsidium_QT_BitcoinSubsidiumUNITS_H
...
/** BitcoinSubsidium unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinSubsidiumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinSubsidiumUnits(QObject *parent);

    /** BitcoinSubsidium units.
      @note Source: https://en.BitcoinSubsidium.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XBTS,
...
typedef BitcoinSubsidiumUnits::Unit BitcoinSubsidiumUnit;

#endif // BitcoinSubsidium_QT_BitcoinSubsidiumUNITS_H
