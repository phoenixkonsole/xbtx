...
#ifndef BitcoinSubsidium_QT_WALLETVIEW_H
#define BitcoinSubsidium_QT_WALLETVIEW_H
...
public:
    ...
    void setBitcoinSubsidiumGUI(BitcoinSubsidiumGUI *gui);
...
#endif // BitcoinSubsidium_QT_WALLETVIEW_H
