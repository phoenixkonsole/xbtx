...
#ifndef BitcoinSubsidium_QT_RESTRICTEDASSETSDIALOG_H
#define BitcoinSubsidium_QT_RESTRICTEDASSETSDIALOG_H
...
#endif // BitcoinSubsidium_QT_RESTRICTEDASSETSSDIALOG_H
