...
#ifndef BitcoinSubsidium_QT_SENDASSETSENTRY_H
#define BitcoinSubsidium_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending BitcoinSubsidiums.
...
#endif // BitcoinSubsidium_QT_SENDASSETSENTRY_H
