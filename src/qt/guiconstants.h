...
#ifndef BitcoinSubsidium_QT_GUICONSTANTS_H
#define BitcoinSubsidium_QT_GUICONSTANTS_H
...
/* BitcoinSubsidiumGUI -- Size of icons in status bar */
...
/* BitcoinSubsidiumcoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05339")
/* BitcoinSubsidiumcoin light orange */
#define COLOR_LIGHT_ORANGE QColor("#f79433")
/* BitcoinSubsidiumcoin dark blue */
#define COLOR_DARK_BLUE QColor("#475eaa")
/* BitcoinSubsidiumcoin light blue */
#define COLOR_LIGHT_BLUE QColor("#5874cf")
/* BitcoinSubsidiumcoin asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* BitcoinSubsidiumcoin shadow color - light mode */
...
/* BitcoinSubsidiumcoin shadow color - dark mode */
#define COLOR_SHADOW_DARK QColor("#0c1b3d")
/* BitcoinSubsidiumcoin Light blue - dark mode - dark mode */
#define COLOR_LIGHT_BLUE_DARK QColor("#1e2636")
/* BitcoinSubsidiumcoin Dark blue - dark mode - dark mode */
#define COLOR_DARK_BLUE_DARK QColor("#0b1018")
/* Pricing widget background color */
#define COLOR_PRICING_WIDGET QColor("#161e2d")
/* BitcoinSubsidiumcoin dark mode administrator background color */
#define COLOR_ADMIN_CARD_DARK COLOR_BLACK
/* BitcoinSubsidiumcoin dark mode regular asset background color */
...
#define QAPP_ORG_NAME "BitcoinSubsidium"
#define QAPP_ORG_DOMAIN "BitcoinSubsidium.org"
#define QAPP_APP_NAME_DEFAULT "BitcoinSubsidium-Qt"
#define QAPP_APP_NAME_TESTNET "BitcoinSubsidium-Qt-testnet"

#endif // BitcoinSubsidium_QT_GUICONSTANTS_H
