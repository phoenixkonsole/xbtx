...
#ifndef BitcoinSubsidium_QT_RPCCONSOLE_H
#define BitcoinSubsidium_QT_RPCCONSOLE_H
...
/** Local BitcoinSubsidium RPC console. */
...
#endif // BitcoinSubsidium_QT_RPCCONSOLE_H
