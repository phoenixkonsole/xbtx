...
#ifndef BitcoinSubsidium_QT_WALLETMODEL_H
#define BitcoinSubsidium_QT_WALLETMODEL_H
...
/** Interface to BitcoinSubsidium wallet from Qt view code. */
...
#endif // BitcoinSubsidium_QT_WALLETMODEL_H
