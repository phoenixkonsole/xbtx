...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(BitcoinSubsidiumUnits::XBTS),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->XBTSBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->XBTSBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("XBTS")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the XBTS balance grid from expanding and looking terrible when asset balance is hidden
