...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(BitcoinSubsidiumUnits::XBTX),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->XBTXBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->XBTXBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, balance, false, BitcoinSubsidiumUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, unconfirmedBalance, false, BitcoinSubsidiumUnits::separatorAlways));
    ui->labelImmature->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, immatureBalance, false, BitcoinSubsidiumUnits::separatorAlways));
    ui->labelTotal->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, BitcoinSubsidiumUnits::separatorAlways));
    ui->labelWatchAvailable->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, watchOnlyBalance, false, BitcoinSubsidiumUnits::separatorAlways));
    ui->labelWatchPending->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, watchUnconfBalance, false, BitcoinSubsidiumUnits::separatorAlways));
    ui->labelWatchImmature->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, watchImmatureBalance, false, BitcoinSubsidiumUnits::separatorAlways));
    ui->labelWatchTotal->setText(BitcoinSubsidiumUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, BitcoinSubsidiumUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("XBTX")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the XBTX balance grid from expanding and looking terrible when asset balance is hidden
