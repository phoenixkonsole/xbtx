...
#ifndef BitcoinSubsidium_QT_BitcoinSubsidiumGUI_H
#define BitcoinSubsidium_QT_BitcoinSubsidiumGUI_H
...
/**
  BitcoinSubsidium GUI main class. This class represents the main window of the BitcoinSubsidium UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitcoinSubsidiumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitcoinSubsidiumGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~BitcoinSubsidiumGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a BitcoinSubsidium wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // BitcoinSubsidium_QT_BitcoinSubsidiumGUI_H
