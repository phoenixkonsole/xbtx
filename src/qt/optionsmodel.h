...
#ifndef BitcoinSubsidium_QT_OPTIONSMODEL_H
#define BitcoinSubsidium_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BitcoinSubsidium client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // BitcoinSubsidiumUnits::Unit
...
#endif // BitcoinSubsidium_QT_OPTIONSMODEL_H
