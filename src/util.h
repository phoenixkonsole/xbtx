 ...
 */
#ifndef BitcoinSubsidium_UTIL_H
#define BitcoinSubsidium_UTIL_H
...
extern const char *const BitcoinSubsidium_CONF_FILENAME;
extern const char *const BitcoinSubsidium_PID_FILENAME;
...
{
    std::string s = strprintf("BitcoinSubsidium-%s", name);
