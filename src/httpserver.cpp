...
{
    RenameThread("BitcoinSubsidium-http");
...
{
    RenameThread("BitcoinSubsidium-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/BitcoinSubsidiumProject/BitcoinSubsidiumcoin/pull/6990)
