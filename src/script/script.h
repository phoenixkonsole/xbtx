...
#ifndef BitcoinSubsidium_SCRIPT_SCRIPT_H
#define BitcoinSubsidium_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinSubsidium always counted CHECKMULTISIGs
...
#endif // BitcoinSubsidium_SCRIPT_SCRIPT_H
