...
#ifndef BitcoinSubsidium_CHAINPARAMS_H
#define BitcoinSubsidium_CHAINPARAMS_H
 ...
 * BitcoinSubsidium system. There are three: the main network on which people trade goods
