...
#ifndef BitcoinSubsidium_TEST_SCRIPTNUM10_H
#define BitcoinSubsidium_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinSubsidium Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BitcoinSubsidium_TEST_BIGNUM_H
