...
BOOST_FIXTURE_TEST_SUITE(addrman_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(addrman_simple_test)
    {
        ...
        BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(0));
        ...
        BOOST_CHECK(addrman.Add(CAddress(addr1, NODE_NONE), source));
         BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(1));
    ...
    BOOST_AUTO_TEST_CASE(addrman_select_test)
    {
        ...
        BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(7));
        ...
        BOOST_CHECK_EQUAL(ports.size(), static_cast<uint64_t>(3));
    }
    ...
    BOOST_AUTO_TEST_CASE(addrman_new_collisions_test)
    {
        ...
        addrman.Add(CAddress(addr1, NODE_NONE), source);
        BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(17));

        CService addr2 = ResolveService("250.1.1.19");
        addrman.Add(CAddress(addr2, NODE_NONE), source);
        BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(18));
    }
    ...
    BOOST_AUTO_TEST_CASE(addrman_tried_collisions_test)
    {
        ...
        addrman.Add(CAddress(addr1, NODE_NONE), source);
        BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(79));

        CService addr2 = ResolveService("250.1.1.81");
        addrman.Add(CAddress(addr2, NODE_NONE), source);
        BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(80));
    }
    ...
    BOOST_AUTO_TEST_CASE(addrman_getaddr_test)
    {
        ...
        BOOST_CHECK_EQUAL(vAddr1.size(), static_cast<uint64_t>(0));
        ...
        BOOST_CHECK_EQUAL(addrman.GetAddr().size(), static_cast<uint64_t>(1));
        ...
        BOOST_CHECK_EQUAL(vAddr.size(), static_cast<uint64_t>(461));
        // (Addrman.size() < number of addresses added) due to address collisions.
        BOOST_CHECK_EQUAL(addrman.size(), static_cast<uint64_t>(2006));
    }
    ...
    BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket_test)
    {
        ...
        BOOST_CHECK_EQUAL(buckets.size(), static_cast<uint64_t>(8));
        ...
        //  8 buckets.
        BOOST_CHECK_EQUAL(buckets.size(), static_cast<uint64_t>(160));
    }
    ...
    BOOST_AUTO_TEST_CASE(caddrinfo_get_new_bucket_test)
    {
        ...
        BOOST_CHECK_EQUAL(buckets.size(), static_cast<uint64_t>(1));
