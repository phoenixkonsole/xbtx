...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.BitcoinSubsidium.org", "www.BitcoinSubsidium.org", -1));
        BOOST_CHECK(TestSplitHost("[www.BitcoinSubsidium.org]", "www.BitcoinSubsidium.org", -1));
        BOOST_CHECK(TestSplitHost("www.BitcoinSubsidium.org:80", "www.BitcoinSubsidium.org", 80));
        BOOST_CHECK(TestSplitHost("[www.BitcoinSubsidium.org]:80", "www.BitcoinSubsidium.org", 80));
