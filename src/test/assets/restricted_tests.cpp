...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler xbtx tx
        CScript xbtxTransfer = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        CTxOut xbtxOut(1*COIN, xbtxTransfer);
        ...
        mutTxTest1.vout.emplace_back(xbtxOut);
        ...
        mutTxTest2.vout.emplace_back(xbtxOut);
        ...
        mutTxTest3.vout.emplace_back(xbtxOut);
        ...
        mutTxTest4.vout.emplace_back(xbtxOut);
        ...
        mutTxTest5.vout.emplace_back(xbtxOut);
        ...
        mutTxTest6.vout.emplace_back(xbtxOut);
        ...
        mutTxTest7.vout.emplace_back(xbtxOut);
        ...
        mutTxTest8.vout.emplace_back(xbtxOut);
