/* src/config/BitcoinSubsidium-config.h.  Generated from BitcoinSubsidium-config.h.in by configure.  */
/* src/config/BitcoinSubsidium-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BitcoinSubsidium_CONFIG_H

#define BitcoinSubsidium_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitcoinSubsidium Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitcoinSubsidium Core"
...
#define PACKAGE_BUGREPORT "https://github.com/BitcoinSubsidiumProject/BitcoinSubsidiumcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinSubsidium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinSubsidium Core 2.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "BitcoinSubsidium"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://BitcoinSubsidiumcoin.org/"
...
#endif //BitcoinSubsidium_CONFIG_H
