...
static void outputEscape()
{
	printf(	"// Automatically generated file. Do not modify.\n"
		"#ifndef BitcoinSubsidium_UNIVALUE_UNIVALUE_ESCAPES_H\n"
		"#define BitcoinSubsidium_UNIVALUE_UNIVALUE_ESCAPES_H\n"
	...
	printf(	"};\n"
		"#endif // BitcoinSubsidium_UNIVALUE_UNIVALUE_ESCAPES_H\n");
}
